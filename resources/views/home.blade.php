                    ...
                    <div class="sm:text-center">
                        ...
                        <div class="mt-5 sm:mt-8 sm:flex sm:justify-center">
                            ...
                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a href="{{ route('customer.login') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-yellow-500 hover:bg-yellow-400 md:py-4 md:text-lg md:px-10"> Customer Login </a>
                            </div>
                            <div class="mt-3 sm:mt-0 sm:ml-3">
                                <a href="{{ route('user.login') }}" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-400 hover:bg-green-500 md:py-4 md:text-lg md:px-10"> User Login </a>
                            </div>
                        </div>
                    </div>
                </main>
